...
class Parser {
    ...
    {
        return $this->nodeAttrAsArray("//League[Bettype/Oddnames/Oddname='0' and Bettype/Oddnames/Oddname='1' and Bettype/Oddnames/Oddname='2' and Bettype/Oddnames/Oddname='10' and Bettype/Oddnames/Oddname='12' and Bettype/Oddnames/Oddname='02']");
    }
    
    protected function getBettypesByLeagueId ($league_id)
    {
        return $this->nodeAttrAsArray("//League[@id='" . $league_id . "']/Bettype[Oddnames/Oddname='0' and Oddnames/Oddname='1' and Oddnames/Oddname='2' and Oddnames/Oddname='10' and Oddnames/Oddname='12' and Oddnames/Oddname='02']");
    }
